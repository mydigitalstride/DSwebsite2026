            ...
            'layouts'      => [ // sorted A–Z by label
                ...
                'layout_cta_banner' => [
                    ...
                    'sub_fields' => [
                        ...
                        [
                            'key' => 'field_cta_carousel', 'label' => 'Carousel Slides', 'name' => 'carousel_images',
                            'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Slide', 'max' => 8,
                            'instructions' => 'Add images or videos for a right-side carousel. Leave empty for centered text layout.',
                            'sub_fields' => [
                                ['key' => 'field_cta_carousel_type', 'label' => 'Slide Type', 'name' => 'media_type', 'type' => 'button_group', 'choices' => ['image' => 'Image', 'video' => 'Video'], 'default_value' => 'image', 'return_format' => 'value'],
                                ['key' => 'field_cta_carousel_img', 'label' => 'Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'array', 'conditional_logic' => [[['field' => 'field_cta_carousel_type', 'operator' => '==', 'value' => 'image']]]],
                                ['key' => 'field_cta_carousel_source', 'label' => 'Video Source', 'name' => 'video_source', 'type' => 'button_group', 'choices' => ['file' => 'Uploaded File', 'url' => 'YouTube / Vimeo URL'], 'default_value' => 'file', 'return_format' => 'value', 'conditional_logic' => [[['field' => 'field_cta_carousel_type', 'operator' => '==', 'value' => 'video']]]],
                                ['key' => 'field_cta_carousel_video_file', 'label' => 'Video File', 'name' => 'video_file', 'type' => 'file', 'return_format' => 'array', 'mime_types' => 'mp4,webm,ogv,mov', 'instructions' => 'Upload MP4 (H.264). Keep hero clips short and compressed. Avoid .MOV — Chrome and Firefox will not play it, and iPhone recordings are usually HEVC, which only Safari supports. Export or convert to MP4 first.', 'conditional_logic' => [[['field' => 'field_cta_carousel_type', 'operator' => '==', 'value' => 'video'], ['field' => 'field_cta_carousel_source', 'operator' => '==', 'value' => 'file']]]],
                                ['key' => 'field_cta_carousel_video_url', 'label' => 'Video URL', 'name' => 'video_url', 'type' => 'url', 'instructions' => 'Paste a YouTube or Vimeo link. Embedded players cannot report when they finish, so the carousel advances on its normal timer — use an uploaded file for a slide that should hold until the video ends. Any other URL is treated as a direct video file.', 'conditional_logic' => [[['field' => 'field_cta_carousel_type', 'operator' => '==', 'value' => 'video'], ['field' => 'field_cta_carousel_source', 'operator' => '==', 'value' => 'url']]]],
                                ['key' => 'field_cta_carousel_video_poster', 'label' => 'Poster Image', 'name' => 'video_poster', 'type' => 'image', 'return_format' => 'array', 'instructions' => 'Shown before the video starts. Uploaded files only.', 'conditional_logic' => [[['field' => 'field_cta_carousel_type', 'operator' => '==', 'value' => 'video'], ['field' => 'field_cta_carousel_source', 'operator' => '==', 'value' => 'file']]]],
                                ['key' => 'field_cta_carousel_video_autoplay', 'label' => 'Autoplay', 'name' => 'video_autoplay', 'type' => 'true_false', 'ui' => 1, 'default_value' => 1, 'instructions' => 'Plays muted when the slide becomes active. Turn off to show play controls instead.', 'conditional_logic' => [[['field' => 'field_cta_carousel_type', 'operator' => '==', 'value' => 'video']]]],
                                ['key' => 'field_cta_carousel_video_loop', 'label' => 'Loop', 'name' => 'video_loop', 'type' => 'true_false', 'ui' => 1, 'default_value' => 0, 'instructions' => 'Looping videos hold the slide until a visitor navigates. Otherwise an uploaded video advances the carousel when it ends.', 'conditional_logic' => [[['field' => 'field_cta_carousel_type', 'operator' => '==', 'value' => 'video']]]],
                                ['key' => 'field_cta_carousel_video_controls', 'label' => 'Show Controls', 'name' => 'video_controls', 'type' => 'true_false', 'ui' => 1, 'default_value' => 0, 'conditional_logic' => [[['field' => 'field_cta_carousel_type', 'operator' => '==', 'value' => 'video']]]],
                ...
                'layout_hero' => [
                    ...
                    'sub_fields' => [
                        ...
                        [
                            'key' => 'field_hero_carousel', 'label' => 'Carousel Slides', 'name' => 'carousel_images',
                            'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Slide', 'max' => 8,
                            'instructions' => 'Add images or videos for the right-side carousel. Leave empty for full-width text hero.',
                            'sub_fields' => [
                                ['key' => 'field_hero_carousel_type', 'label' => 'Slide Type', 'name' => 'media_type', 'type' => 'button_group', 'choices' => ['image' => 'Image', 'video' => 'Video'], 'default_value' => 'image', 'return_format' => 'value'],
                                ['key' => 'field_hero_carousel_img', 'label' => 'Image', 'name' => 'image', 'type' => 'image', 'return_format' => 'array', 'conditional_logic' => [[['field' => 'field_hero_carousel_type', 'operator' => '==', 'value' => 'image']]]],
                                ['key' => 'field_hero_carousel_source', 'label' => 'Video Source', 'name' => 'video_source', 'type' => 'button_group', 'choices' => ['file' => 'Uploaded File', 'url' => 'YouTube / Vimeo URL'], 'default_value' => 'file', 'return_format' => 'value', 'conditional_logic' => [[['field' => 'field_hero_carousel_type', 'operator' => '==', 'value' => 'video']]]],
                                ['key' => 'field_hero_carousel_video_file', 'label' => 'Video File', 'name' => 'video_file', 'type' => 'file', 'return_format' => 'array', 'mime_types' => 'mp4,webm,ogv,mov', 'instructions' => 'Upload MP4 (H.264). Keep hero clips short and compressed. Avoid .MOV — Chrome and Firefox will not play it, and iPhone recordings are usually HEVC, which only Safari supports. Export or convert to MP4 first.', 'conditional_logic' => [[['field' => 'field_hero_carousel_type', 'operator' => '==', 'value' => 'video'], ['field' => 'field_hero_carousel_source', 'operator' => '==', 'value' => 'file']]]],
                                ['key' => 'field_hero_carousel_video_url', 'label' => 'Video URL', 'name' => 'video_url', 'type' => 'url', 'instructions' => 'Paste a YouTube or Vimeo link. Embedded players cannot report when they finish, so the carousel advances on its normal timer — use an uploaded file for a slide that should hold until the video ends. Any other URL is treated as a direct video file.', 'conditional_logic' => [[['field' => 'field_hero_carousel_type', 'operator' => '==', 'value' => 'video'], ['field' => 'field_hero_carousel_source', 'operator' => '==', 'value' => 'url']]]],
                                ['key' => 'field_hero_carousel_video_poster', 'label' => 'Poster Image', 'name' => 'video_poster', 'type' => 'image', 'return_format' => 'array', 'instructions' => 'Shown before the video starts. Uploaded files only.', 'conditional_logic' => [[['field' => 'field_hero_carousel_type', 'operator' => '==', 'value' => 'video'], ['field' => 'field_hero_carousel_source', 'operator' => '==', 'value' => 'file']]]],
                                ['key' => 'field_hero_carousel_video_autoplay', 'label' => 'Autoplay', 'name' => 'video_autoplay', 'type' => 'true_false', 'ui' => 1, 'default_value' => 1, 'instructions' => 'Plays muted when the slide becomes active. Turn off to show play controls instead.', 'conditional_logic' => [[['field' => 'field_hero_carousel_type', 'operator' => '==', 'value' => 'video']]]],
                                ['key' => 'field_hero_carousel_video_loop', 'label' => 'Loop', 'name' => 'video_loop', 'type' => 'true_false', 'ui' => 1, 'default_value' => 0, 'instructions' => 'Looping videos hold the slide until a visitor navigates. Otherwise an uploaded video advances the carousel when it ends.', 'conditional_logic' => [[['field' => 'field_hero_carousel_type', 'operator' => '==', 'value' => 'video']]]],
                                ['key' => 'field_hero_carousel_video_controls', 'label' => 'Show Controls', 'name' => 'video_controls', 'type' => 'true_false', 'ui' => 1, 'default_value' => 0, 'conditional_logic' => [[['field' => 'field_hero_carousel_type', 'operator' => '==', 'value' => 'video']]]],
